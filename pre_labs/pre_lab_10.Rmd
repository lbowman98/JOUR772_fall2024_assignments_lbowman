...
**Task** Run the following code. Describe the output in the space below. **Answer: It created a new dataframe with just Maryland counties.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: It created a map of Maryland counties.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: This shows the foreclosure rate for each county in Maryland.**
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **Answer: The map shows the rate of foreclosure by county but in greater detail than the previous map. The most apparent pattern is that foreclosures are more common in rural areas – parts of the eastern shore, southern and western Maryland. However, this could be a false positive, since those areas have smaller populations.**
