...
**Task** Run the following code to load the Zip Code Tabulation Area data for Maryland. What's the datatype of the ZCTA5N column? **Answer: Num**
...
**Task** Run the following code to change the datatype of ZCTA5N from numeric to character. What's the datatype of ZCTA5N? **Answer: Now it's a chr**
...
assessment_by_county <- maryland_zcta |> inner_join (assessment, join_by (ZCTA5N== zipcode))
