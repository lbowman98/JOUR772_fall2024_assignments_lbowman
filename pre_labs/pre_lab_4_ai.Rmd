...
evans_response <- axolotr::ask(
  prompt = paste("Given the following text, extract information into a CSV file with the following structure, including headers: celebrant1,celebrant2,location_city, location_state,officiant,celebrant1_age,celebrant2_age,celebrant1_parent1,celebrant1_parent2,celebrant2_parent1,celebrant2_parent2", text),
  model = "llama-3.1-8b-instant"
)
...
```{r}
groq_data_response <- axolotr :: ask(
  prompt = "I have a CSV file of cancer screenings of Maryland residents. Using R and the tidyverse, suggest some ways I could find patterns in the data",
  model = "llama-3.1-8b-instant"
)
...
**Your comment: The response from groq was appropriate, but pretty basic. It suggested breaking down the data by demographics like screening rate by age or gender. What is helpful, I found, is that the response included specific functions that I could use to get this done. Also that the program made suggestions for how to visualize the data in a scatter plot.**
