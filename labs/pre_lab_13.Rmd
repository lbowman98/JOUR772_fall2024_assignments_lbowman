...
**Task** Run the following code. Describe the plot. What pattern do you see? **Answer: Slight positive correlation but very scattered; heavy concentration in the middle.**
...
**Task** Run the following code. Describe the plot. What do you see? **Answer: Slight negative correlation but, again, very messy.**
...
**Task** Run the following code. Describe the model output. What do you see? **Answer: The negative T-value denotes a negative correlation. The relatively high p-value, however, suggests a lot of randomness between the two data sets, which calls the usefulness of the data into question.**
